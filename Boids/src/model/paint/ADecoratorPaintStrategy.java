 ...
 * A subclass should override one or more methods, adding additional processing 
 * either before or after delegating to the decoree. Note that this class cannot be 
 * used by the BallWorld system directly as it lacks a no-parameter constructor.
 * @author kq2
 */
